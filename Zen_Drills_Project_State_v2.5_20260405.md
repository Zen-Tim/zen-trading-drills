# Zen Drills — Project State v2.5 · 20260405
...
- Virtual sections: Recent (items added after seed), Neglected (items not drilled in 30+ days)
...
- `isVirtual` prop system — Recent and Neglected share behaviour (no New Round, no reorder/delete, no add-item)
...
| 20260404 | Bug fixes: edit-update sync, analytics wiring, date format helper. UI: line break preservation, image lightbox. Added Strategies section via SQL. |
| 20260405 | Neglected virtual section (30+ days stale). Renamed isRecent to isVirtual across all components. |
...
| v2.4 | 20260405 | Added Neglected section prompt. Cleaned up old fix docs from repo. |
| v2.5 | 20260405 | Neglected section deployed. Prompt file cleaned up. |
